...
def search(r):
    key=r.GET.get("key")
    return render(r,"search-results.html",{"key":key})
...
def bookList(r):
    ...
    return render(r,"list.html",context)
...
def Publisher_edit(request,pk=None):
    ...
    return render(request, "instance-form.html", {"method": request.method, "form": form,"instance":publisher,"model_type":"Publisher"})
#@login_required
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            if review is None:
                ...
                updated_review.data_edited=timezone.now()
...
def Publisher_edit(request,pk=None):
    if request.method=="POST":
        ...
        if form.is_valid():
            ...
            p=Publisher(name=form.cleaned_data.get("name"),website=form.cleaned_data.get("website"),email=form.cleaned_data.get("email"))
            p.save()
    ...
    return render(request,"form-example.html",context={"form":form,"method":request.method})
